...
defined('MODE_PATH')    or define('MODE_PATH',      EXTEND_PATH.'Mode/'); // 模式扩展目录		// mos - 可删除
defined('ENGINE_PATH')  or define('ENGINE_PATH',    EXTEND_PATH.'Engine/'); // 引擎扩展目录		// mos - 可删除
...
defined('COMMON_PATH')  or define('COMMON_PATH',    SYSTEM_PATH.'common/'); // 项目公共目录		// mos - 可放入 核心
defined('LIB_PATH')     or define('LIB_PATH',       SYSTEM_PATH.'library/'); // 项目类库目录
